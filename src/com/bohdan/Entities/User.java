...
public class User {
    ...
    public static final String CUSTOMER_INFO_PATH = "FlatDB/CustomerInfo/";
    public static final String TRANSACTIONS_PATH = "FlatDB/Transactions/";
    static final String EXPENSE_CATEGORIES_PATH = "FlatDB/ExpenseCategories/";
    static final String INCOME_CATEGORIES_PATH = "FlatDB/IncomeCategories/";
    ...
    public void saveUser() throws IOException {
        ...
        try (BufferedWriter userFile = new BufferedWriter(new FileWriter(CUSTOMER_INFO_PATH + this.name + "s Info.txt"));
             BufferedWriter transactionData = new BufferedWriter(new FileWriter(TRANSACTIONS_PATH + this.name + "s Transactions.txt"));
             BufferedWriter expCategories = new BufferedWriter(new FileWriter(EXPENSE_CATEGORIES_PATH + this.name + "s ExpCategories.txt"));
             BufferedWriter incCategories = new BufferedWriter(new FileWriter(INCOME_CATEGORIES_PATH + this.name + "s IncCategories.txt"))) {
